...
export const Config: Schema<Config> = Schema.object({
  shared: Schema.object({
    cookie: Schema.string().description('B 站 Cookie').role('textarea').default(''),
    userAgent: Schema.string().description('User-Agent').role('textarea').default('Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36'),
  }),
